...
CREATE TABLE `task` (
  ...
  PRIMARY KEY (`task_id`),
  KEY `FKmqdeuwq5c990bktnl9noggvt4` (`parenttask_id`),
  CONSTRAINT `FKmqdeuwq5c990bktnl9noggvt4` FOREIGN KEY (`parenttask_id`) REFERENCES `parent_task` (`parenttask_id`)
...
-- Dump completed on 2019-12-09 22:24:12
